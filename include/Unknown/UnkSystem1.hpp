...
// seems to be a filesystem targeting the save file
...
public:
    ...
    /* 0C */ virtual void vfunc_0C() override; // func_ov000_02067434
    /* 10 */ virtual void vfunc_10() override; // func_ov000_02067474
...
public:
    ...
    /* 0C */ virtual void vfunc_0C() override; // func_ov000_0209fcdc
