...
DEFINE_ACTOR_TYPE('AROW', ShotArrow)
...
DEFINE_ACTOR_TYPE('MKUR', FleeingSpinut)
...
DEFINE_ACTOR_TYPE('NITF', ItemFlower)
...
DEFINE_ACTOR_TYPE('RLST', RollingStone)
