...
static ActorProfileUnkTRIC sActorProfileUnkTRIC;

ARM ActorProfileUnkTRIC *ActorProfileUnkTRIC::GetProfile() {
    return &sActorProfileUnkTRIC;
}

ARM Actor *ActorProfileUnkTRIC::Create() {
