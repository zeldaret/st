...
static ActorProfileUnkDKTR sActorProfileUnkDKTR;

ARM ActorProfileUnkDKTR *ActorProfileUnkDKTR::GetProfile() {
    return &sActorProfileUnkDKTR;
}
...
ActorUnkDKTR::~ActorUnkDKTR() {}
ActorProfileUnkDKTR::~ActorProfileUnkDKTR() {}
