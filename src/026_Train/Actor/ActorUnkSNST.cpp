...
static ActorProfileUnkSNST sActorProfileUnkSNST;

ARM ActorProfileUnkSNST *ActorProfileUnkSNST::GetProfile() {
    return &sActorProfileUnkSNST;
}

ARM Actor *ActorProfileUnkSNST::Create() {
