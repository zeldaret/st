...
UnkSystem1_ov000_Derived1::~UnkSystem1_ov000_Derived1() {
    u8 local_10[4];
...
void UnkSystem1_ov000_Derived1::func_ov000_0206738c() {
    u8 local_10[4];
...
void UnkSystem1_ov000_Derived1::vfunc_08(unk32 param1) {
    if (this->mUnk_0C != 0) {
...
unk32 UnkSystem1_ov000_Derived1::vfunc_0C() {
    u8 local_10[4];
...
unk32 UnkSystem1_ov000_Derived1::vfunc_10(u16 *param1) {
    switch (param1[1]) {
        case 1:
        case 2:
        case 3:
