...
static ActorProfileUnkRMVD sActorProfileUnkRMVD;

ARM ActorProfileUnkRMVD *ActorProfileUnkRMVD::GetProfile() {
    return &sActorProfileUnkRMVD;
}
...
ActorUnkRMVD::~ActorUnkRMVD() {}
ActorProfileUnkRMVD::~ActorProfileUnkRMVD() {}