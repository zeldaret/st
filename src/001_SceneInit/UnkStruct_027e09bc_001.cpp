...
UnkStruct_027e09bc::UnkStruct_027e09bc() {
    ...
    if (data_027e09a4->IsSceneModeAdventure()) {
        this->mUnk_04[2] = new(HeapIndex_1) UnkStruct_027e09bc_0C(0);
        this->mUnk_04[3] = new(HeapIndex_1) UnkStruct_027e09bc_0C(1);
        ...
        this->mUnk_04[0] = this->mUnk_14[data_ov020_020e8544->vfunc_20()];
    }
}

UnkStruct_027e09bc::~UnkStruct_027e09bc() {
    delete this->mUnk_04[2];
    delete this->mUnk_04[3];
...
void UnkStruct_027e09bc::func_ov001_020bab5c() {
    switch ((s32) data_027e09a4->CurrentSceneIndex()) {
        ...
        case SceneIndex_tekiya09:
            data_027e09bc->mUnk_04[3]->mUnk_264 = 0x7B;
            break;
        case SceneIndex_b_last2:
            data_027e09bc->mUnk_04[3]->mUnk_264 = 0x00;
            break;
        ...
        default:
            if (data_027e09a4->IsSceneModeAdventure()) {
                data_027e09bc->mUnk_04[3]->func_ov000_02078cec();
            }
            break;
    }
}
...
void UnkStruct_027e09bc::func_ov001_020babc8() {
    if (data_027e09a4->IsSceneModeAdventure()) {
        this->mUnk_04[2]->func_ov000_02078ba4();
        this->mUnk_04[3]->func_ov000_02078ba4();
    }
}

void UnkStruct_027e09bc::func_ov001_020babe8() {
    if (data_027e09a4->IsSceneModeAdventure()) {
        this->mUnk_04[2]->mUnk_280 = 0;
        this->mUnk_04[3]->mUnk_280 = 0;
    }
}
