...
static ActorProfileUnkRBRP sActorProfileUnkRBRP;

ARM ActorProfileUnkRBRP *ActorProfileUnkRBRP::GetProfile() {
    return &sActorProfileUnkRBRP;
}

ARM Actor *ActorProfileUnkRBRP::Create() {
    return new(HeapIndex_2) ActorUnkRBRP();
}

ARM ActorProfileUnkRBRP::ActorProfileUnkRBRP() :
    ActorProfile_Derived1(ActorId_RBRP) {}

ARM ActorUnkRBRP::ActorUnkRBRP() {}
...
ARM void ActorUnkRBRP::func_ov069_0215a834(void) {}
ARM void ActorUnkRBRP::func_ov069_0215a84c(void) {}
ARM void ActorUnkRBRP::func_ov069_0215a868(void) {}

ActorUnkRBRP::~ActorUnkRBRP() {}
ActorProfileUnkRBRP::~ActorProfileUnkRBRP() {}
