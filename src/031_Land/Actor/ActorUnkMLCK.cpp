...
static ActorProfileUnkMLCK sActorProfileUnkMLCK;

ARM ActorProfileUnkMLCK *ActorProfileUnkMLCK::GetProfile() {
    return &sActorProfileUnkMLCK;
}

ARM Actor *ActorProfileUnkMLCK::Create() {
