...
static ActorProfileUnkVLCR sActorProfileUnkVLCR;

ARM ActorProfileUnkVLCR *ActorProfileUnkVLCR::GetProfile() {
    return &sActorProfileUnkVLCR;
}

ARM Actor *ActorProfileUnkVLCR::Create() {
