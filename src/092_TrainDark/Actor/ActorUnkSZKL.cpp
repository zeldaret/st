...
static ActorProfileUnkSZKL sActorProfileUnkSZKL;

ARM ActorProfileUnkSZKL *ActorProfileUnkSZKL::GetProfile() {
    return &sActorProfileUnkSZKL;
}

ARM Actor *ActorProfileUnkSZKL::Create() {
