...
static ActorProfileUnkTMNA sActorProfileUnkTMNA;

ARM ActorProfileUnkTMNA *ActorProfileUnkTMNA::GetProfile() {
    return &sActorProfileUnkTMNA;
}

ARM Actor *ActorProfileUnkTMNA::Create() {
