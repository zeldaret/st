...
static ActorProfileUnkRBD2 sActorProfileUnkRBD2;

ARM ActorProfileUnkRBD2 *ActorProfileUnkRBD2::GetProfile() {
    return &sActorProfileUnkRBD2;
}

ARM Actor *ActorProfileUnkRBD2::Create() {
