...
static ActorProfileUnkDMMT sActorProfileUnkDMMT;

ARM ActorProfileUnkDMMT *ActorProfileUnkDMMT::GetProfile() {
    return &sActorProfileUnkDMMT;
}

ARM Actor *ActorProfileUnkDMMT::Create() {
