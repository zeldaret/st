...
static ActorProfileUnkBDBA sActorProfileUnkBDBA;

ARM ActorProfileUnkBDBA *ActorProfileUnkBDBA::GetProfile() {
    return &sActorProfileUnkBDBA;
}

ARM Actor *ActorProfileUnkBDBA::Create() {
    return new(HeapIndex_2) ActorUnkBDBA();
}

ARM ActorProfileUnkBDBA::ActorProfileUnkBDBA() :
    ActorProfile_Derived1(ActorId_BDBA) {}
