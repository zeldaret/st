...
extern "C" unk32 func_ov024_020d54a0(int);
...
MapObjectProfile_Derived5::MapObjectProfile_Derived5(unk32 param1, int) :
    MapObjectProfile_Derived2_20_Base("Train", func_ov024_020d46b4(param1), "model", "anm", 1, func_ov024_020d54a0(param1)) {}

MapObjectProfile_Derived5::MapObjectProfile_Derived5(unk32 param1) :
