...
void AdventureModeManager_178_Base::vfunc2_08(unk32 param1) {
...
void AdventureModeManager_178_Base::vfunc2_0C(unk32 param1) {
    if (this->mUnk_10.mUnk_0D == this->mUnk_10.mUnk_10) {
        data_0204a088->func_ov000_02061230();
    }
}

void AdventureModeManager_178_Base::vfunc2_18(unk32 param1) {
    if (param1 == 1 || param1 == 5) {
        this->mUnk_10.func_0201bb84(0x14, 2, 0x14);
        data_0204e5f8.func_0201b9a8(&this->mUnk_10);
    }
...
void AdventureModeManager_178_Base::vfunc_5C(unk32 param1) {
    if (this->mUnk_10.mUnk_0D == this->mUnk_10.mUnk_10) {
        data_0204a088->func_ov000_02061230();
    }
}
